...
const informationSection = () => {
    const informationFieldLabelMap = new Map([
        ...
        ['Cluster__r.Name','Cluster']
    ]);
    const informationFields = ['Name', 'RecordType', 'Phone', 'Website','Beer_Selection__c','Channel__c', 'Sub_Channel__c', 'Type__c','Competitor_Non_Premium_Sales__c','Competitor_Premium_Sales__c', 'Email__c', 'Excise_Code__c', 'GST__c', 'Local_Sales_Tax_Number__c','QCO_Flag__c','MTD_Sales__c', 'QTD_Sales__c','Cluster__r.Name'];
