...
const formRender = (channel) => {
    ...
    for(let i = 0;i<competitorVisibility.length;i++){
       ...
       if(i<3||i>3){
        ...
        tmp += `<div class="col-xs-6" style="color:#ed2228">${competitorVisibility[i].Competitor_Name}</div>`;
    ...
    isCraftEnabled(competitorVisibility[4].show_panel);
};
...
const onPrem = (index) => {
  ...
  if(competitorVisibility[index].Led_Signage){
    ...
    tmp += `<div class="col-xs-4" ><div class="${index}-Led_Signage"  style="margin-top:-4px;">
  ${createImgInput((index+'-Led_Signage_File'),'',(competitorVisibility[index].Led_Signage_File ? competitorVisibility[index].Led_Signage_File : null) ,"fileInput(this)",true)}
    ...
    tmp += `<div class="col-xs-4" ><div class="${index}-Led_Signage"  style="margin-top:-4px;display:none;">
  ${createImgInput((index+'-Led_Signage_File'),'',(competitorVisibility[index].Led_Signage_File ? competitorVisibility[index].Led_Signage_File : null) ,"fileInput(this)",true)}
  </div></div>`;
  }
  tmp += '</div>';
  tmp += '<div class="row">';
  tmp += '<div class="col-xs-4" style="padding-top:3%" >';
  tmp += 'Draft';
  tmp += '</div>';
  tmp += '<div class="col-xs-4" style="margin-top:2%;">';
  ...
  if(competitorVisibility[index].Draft){
    tmp += `<div class="col-xs-4"><div class="${index}-Draft" style="margin-top:-4px;">
    ...
    tmp += `<div class="col-xs-4"><div class="${index}-Draft" style="margin-top:-4px;display:none;">
  ${createImgInput((index+'-Draft_File'),'',(competitorVisibility[index].Draft_File ? competitorVisibility[index].Draft_File : null) ,"fileInput(this)",true)}
  </div></div>`;
  }
  tmp += '</div>';
  ...
  if(competitorVisibility[index].Customized_Branding){
    tmp += `<div class="col-xs-4" ><div class="${index}-Customized_Branding" style="margin-top:-4px;">
  ${createImgInput((index+'-Customized_Branding_File'),'',(competitorVisibility[index].Customized_Branding_File ? competitorVisibility[index].Customized_Branding_File : null) ,"fileInput(this)",true)}
    ...
    tmp += `<div class="col-xs-4"> <div class="${index}-Customized_Branding" style="margin-top:-4px;display:none;">
    ${createImgInput((index+'-Customized_Branding_File'),'',(competitorVisibility[index].Customized_Branding_File ? competitorVisibility[index].Customized_Branding_File : null) ,"fileInput(this)",true)}
    </div></div>`;
  }
  tmp +='</div>';
  ...
  if(competitorVisibility[index].Menu_Listing){
    tmp += `<div class="col-xs-4" > <div class="${index}-Menu_Listing"  style="margin-top:-4px;">
  ${createImgInput((index+'-Menu_Listing_File'),'',(competitorVisibility[index].Menu_Listing_File ? competitorVisibility[index].Menu_Listing_File : null) ,"fileInput(this)",true)}
    ...
    tmp += `<div class="col-xs-4" > <div class="${index}-Menu_Listing"  style="margin-top:-4px;display:none;">
  ${createImgInput((index+'-Menu_Listing_File'),'',(competitorVisibility[index].Menu_Listing_File ? competitorVisibility[index].Menu_Listing_File : null) ,"fileInput(this)",true)}
  </div></div>`;
  }
  tmp+= '</div>';
...
const offPrem = (index) => {
  ...
  tmp += '</div>';
  if(competitorVisibility[index].Draft){
    tmp += `<div class="col-xs-4"><div class="${index}-VisiCooler" style="margin-top:-4px;">
    ...
    tmp += `<div class="col-xs-4"><div class="${index}-VisiCooler" style="margin-top:-4px;display:none;">
  ${createImgInput((index+'-VisiCooler_File'),'',(competitorVisibility[index].VisiCooler_File ? competitorVisibility[index].VisiCooler_File : null) ,"fileInput(this)",true)}
  </div></div>`;
  }
  tmp +='</div>';
  ...
  if(competitorVisibility[index].Indoor_Shelf){
    tmp += `<div class="col-xs-4" ><div class="${index}-Indoor_Shelf" style="margin-top:-4px;">
  ${createImgInput((index+'-Indoor_Shelf_File'),'',(competitorVisibility[index].Indoor_Shelf_File ? competitorVisibility[index].Indoor_Shelf_File : null) ,"fileInput(this)",true)}
    ...
    tmp += `<div class="col-xs-4"> <div class="${index}-Indoor_Shelf" style="margin-top:-4px;display:none;">
    ${createImgInput((index+'-Indoor_Shelf_File'),'',(competitorVisibility[index].Indoor_Shelf_File ? competitorVisibility[index].Indoor_Shelf_File : null) ,"fileInput(this)",true)}
    </div></div>`;
  }
  tmp += '</div>';
...
const createVisibilityDashboard = () =>{
  ...
  let tableHead = `
  <div class="item">
  <h4 class="text-center">Visibility Elements Dashboard</h4>
