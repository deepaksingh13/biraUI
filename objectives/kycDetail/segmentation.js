...
const recordWiseFields = () => {
  ...
  recordTypeWiseField = new Map([
    ...
    ['On_Premise_Hotel', ['Channel', 'Sub_Channel', 'Beacon_Flag', 'QCO_Flag', 'Type', 'Ocassion', 'Cuisine', 'Outdoor_Seating', 'Pool_Side', 'Location', 'Beer_Selection', 'No_of_Rooms', 'Star_Rating', 'No_of_Banquets', 'Minibar_Available', 'Zomato_Cost_for_2', 'Other_Entertainment']]
  ]);
  fieldType = new Map([
    ['Channel', 'Picklist'],
